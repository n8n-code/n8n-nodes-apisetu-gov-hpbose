...
export const apIsDescription: INodeProperties[] = [
			...
			"options": [
				{
					"name": "Hvcer",
					"value": "Hvcer",
					"action": "Class XII Provisional Certificate",
					"description": "API to verify Class XII Provisional Certificate.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/hvcer/certificate"
						}
					}
				},
				{
					"name": "Svcer",
					"value": "Svcer",
					"action": "Class X Provisional Certificate",
					"description": "API to verify Class X Provisional Certificate.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/svcer/certificate"
						}
					}
				}
			],
		...
		{
			"displayName": "POST /hvcer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /svcer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
